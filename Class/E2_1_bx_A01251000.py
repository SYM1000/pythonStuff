...
for x in range(0,estudiantes): #Aqui se esta creando un ciclo de tipo for que se va repetir por cada estudiante, en el que se le pedira sus 3 calificaciones
