...
def main():
    ...
    print("[10] - Calcular la cantidad de calorias por dia recomendadas")
    ...
    if usuario == 1:
        ...
        print("\nTu peso es: ", peso_k, "kg y ", "tu altura es ", altura_m, "m,", "por lo tanto tu imc es de:", imc,
              "puntos")
        ...
        print("--->", segundos, "segundos son: ", segundos_h, "horas,", int(segundos_m), "minutos,", segundos_s,
              "segundos")
        ...
        print("La cantidad de muertes en ", años, "años", "es de:", muertes, "personas",
              "y la cantidad de nacimientos en", años, "años", "es de:", nacimientos, " personas")
        ...
        print("\nCon este programa conoceremos el area de un trapezoide a partir de la medida de sus partes \n")
        ...
        # altura_m = float(input("¿Cuanto mides en metros? "))
        # edad = int(input("¿Cuantos años tienes? "))

        sexo_h = ["Hombre", "hombre", "macho", "ombre", "bato", "Masculino", "masculino", "M", "m"]
        sexo_m = ["Mujer", "mujer", "morra", "Femenino", "femenino", "F", "f"]

        print("\nCon este programa calcularemos la cantidad de calorias por dia recomendadas para ti")
        usuario = str(input("\nEres hombre o mujer "))

        if usuario in sexo_h:
            peso = float(input("¿Cuanto pesas en Kg? "))
            altura_m = float(input("¿Cuanto mides en metros? "))
            edad = int(input("¿Cuantos años tienes? "))

            altura_cm = altura_m * 100
            calorias_ideal = 66.5 + (13.75 * peso) + (5 * altura_cm) - (6.78 * edad)
            calorias_ideal = int(calorias_ideal)

            print("Es recomendable para tu persona que consumas", calorias_ideal, "Calorias diarias")
